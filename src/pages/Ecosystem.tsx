...
const roadmapData = [
  ...
  {
    title: "Q2 2025 - NeuroSwarm",
    status: "completed",
    items: [
      "Product NeuroSwarm Launched",
      "Community members reaches 50k",
      "10 new AI startup partnerships, to empower them by community compute.",
      "Big giveaways of 1 Million $NLOV tokens + $50,000 USDT",
    ],
  },
  {
  ...
  {
    title: "Q1 2026 - Token Generation Event & Global Access",
    status: "upcoming",
    items: [
      "TGE – Official $NLOV market launch.",
      "Governance Activation – On-chain voting for holders.",
      "Feature Voting – Community decides on upgrades.",
      "CEX & DEX Listings – Exchange listings + liquidity pools.",
    ],
  },
];
    ...
    >
      <SectionContainer className="pb-8 ">
        ...
        <div className="flex justify-center mb-20 md:mb-10">
            <TabsList className="grid grid-cols-2 md:grid-cols-2 gap-5 h-auto p-3 md:p-0 border border-[#0361DA] hover:border-[#0361DA]/50 shadow-md transition-all duration-300 hover:shadow-lg">
