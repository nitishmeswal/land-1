...
const resources = [
  {
    ...
    links: [
      {
        text: "Whitepaper",
        url: "https://docsend.com/view/rtzd2dzpw3v9ayxw",
...
console.log(
  "DEBUG: Loaded blogs:",
  getAllBlogs().map((b) => ({ slug: b.slug, title: b.title, date: b.date }))
);
              ...
              >
                <CardHeader>
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    <CardTitle className="text-lg mb-1 group-hover:text-[#0361DA] transition-colors">
                      {blog.title}
                    </CardTitle>
                  </div>
                  ...
                  <div className="flex flex-col gap-3">
                    ...
                    >
                      <a
                        ...
                        className="group/link flex items-center gap-2"
                      >
                        <span className="font-medium text-[#0361DA]">
                          Read More
                        </span>
                        <ArrowUpRight className="h-4 w-4 opacity-0 group-hover/link:opacity-100 transition-opacity" />
                      </a>
