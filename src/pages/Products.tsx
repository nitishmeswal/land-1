                  ...
                  <div className="flex flex-col md:flex-row gap-8 items-center">
                    <div className="md:w-1/2">
                      ...
                      <p className="text-muted-foreground mb-6">
                        Join our network of GPU providers and earn NLOV tokens
                        for sharing your compute resources. Our platform makes
                        it easy to monetize your idle hardware.
                      </p>
                  ...
                  <div className="relative z-10 glass-card p-8 rounded-xl border border-#0361DA/10 max-w-lg mx-auto">
                    ...
                    <div className="space-y-4 mb-6">
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          <h4 className="font-medium">Create account on NeuroSwarm</h4>
                          <p className="text-sm text-muted-foreground">
                            Simple login with Google or Email
                          </p>
                        </div>
                      </div>
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          <h4 className="font-medium">Scan your Device</h4>
                          <p className="text-sm text-muted-foreground">
                            Scan to get your reward tier for your device
                          </p>
                        </div>
                      </div>
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-muted-foreground">
                            Get paid automatically as you complete tasks
                          </p>
                        </div>
                      </div>
                    </div>
                ...
                <div className="glass-card p-8 rounded-xl border border-#0361DA/10">
                  <div className="flex flex-col md:flex-row gap-8 items-center">
                    ...
                    <div className="md:w-1/2">
                      ...
                      <p className="text-muted-foreground mb-6">
                        Create sophisticated AI agents without writing a single
                        line of code. Our visual builder lets you design, test,
                        and deploy agents in minutes.
                      </p>
