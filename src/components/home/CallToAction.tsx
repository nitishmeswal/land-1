  ...
  return (
    <section className="py-24 relative overflow-hidden">
      ...
      <div className="absolute inset-0 -z-10">
        <div className="absolute inset-0 bg-gradient-radial from-[#0361DA]/20 to-transparent opacity-60"></div>
        ...
        {/* Animated particles */}
        <div className="absolute top-20 left-1/4 w-4 h-4 bg-[#0361DA]/30 rounded-full animate-float"></div>
        <div className="absolute top-40 right-1/4 w-3 h-3 bg-blue-400/30 rounded-full animate-float animation-delay-700"></div>
        <div className="absolute bottom-20 left-1/3 w-5 h-5 bg-[#0361DA]/30 rounded-full animate-float animation-delay-1500"></div>
      </div>

      <Container>
        <div className="glass-card max-w-3xl mx-auto p-10 text-center rounded-2xl shadow-neon border border-[#0361DA]/20 backdrop-blur-md bg-gradient-to-b from-background/90 to-background/70 relative overflow-hidden">
          {/* Background grid */}
          ...
          <div className="inline-flex items-center gap-2 px-4 py-1 rounded-full bg-[#0361DA]/10 text-[#0361DA] text-sm font-medium mb-4 reveal reveal-delay-1">
            <Sparkles className="h-4 w-4 animate-pulse" />
            <span>Coming Soon</span>
          </div>

          <h2 className="text-3xl font-bold mb-4 reveal reveal-delay-1">
            Don't Miss the $NLOV Presale
          </h2>

          <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto reveal reveal-delay-2">
            Join our newsletter to be the first to know when our presale
            launches. Get exclusive access, early bird rewards, and important
            updates about the future of AI compute.
          </p>
          ...
          <div className="max-w-md mx-auto mb-8 reveal reveal-delay-3">
            ...
            >
              <input
                ...
                className="flex-1 px-4 py-3 bg-background/50 rounded-xl border border-[#0361DA]/20 focus:border-[#0361DA] focus:ring-1 focus:ring-[#0361DA] outline-none transition-all duration-300"
              />
              <Button
                type="submit"
                variant="neon"
