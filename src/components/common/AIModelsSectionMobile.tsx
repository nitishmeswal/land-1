...
const AIModelsSectionMobile: React.FC = () => {
  return (
    <section className="relative w-full  py-8 bg-[#030924]">
      {/* Simple AI Models Card */}

      <div className="absolute inset-0 top-10">
        <img
          src="/landing-ai-model/base-1.png"
          alt=""
      ...
      >
        ...
        <div className="relative z-10 h-full flex flex-col p-6">
          ...
          <div className="relative top-[-50px] flex justify-center items-center ">
            <div className="w-full flex items-start justify-center">
              <img
                src="/landing-ai-model/ai-model.gif"
                alt="AI Model Visualization"
                className="w-[60%] h-auto rotate-90 object-fill"
              />
            </div>
          </div>

          {/* Stats Section - More compact */}
          <div className="space-y-2 mb-4 relative top-[-75px]">
            <div className="flex items-center gap-3">
              <div className="w-7 h-7 bg-[#0361DA] rounded-lg flex items-center justify-center flex-shrink-0">
                <svg
                  className="w-4 h-4 text-[#ACD2FF]"
                  viewBox="0 0 24 24"
                  fill="none"
                >
                  <rect
